...
export default function HomePage() {
  return (
    <main className="min-h-screen bg-gray-950 text-white font-sans">
      <header className="bg-gradient-to-r from-purple-600 to-pink-500 p-6 shadow-xl">
        <h1 className="text-4xl font-bold text-white">Toonix TV</h1>
        <p className="text-sm mt-1">Movies, Anime, Cartoons & Shows - Straight from Telegram</p>
      </header>
